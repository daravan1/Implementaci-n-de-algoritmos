...
public class PrimNoDirigido {
    int V;
    LinkedList<Edge>[] adj;

    PrimNoDirigido(int v) {
        V = v;
    ...
    void addEdge(int src, int dest, int peso) {
        ...
        adj[dest].add(new Edge(dest, src, peso)); // grafo no dirigido
    }
    ...
    void primMST() {
        ...
        guardarResultadoEnArchivo(result, "ResultadoPrimNoDirigido.txt");
    }
    ...
    public static void main(String[] args) {
        PrimNoDirigido grafo = new PrimNoDirigido(0);
