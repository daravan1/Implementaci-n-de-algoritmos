...
public class KruskalDirigido {
    int V, E;
    Edge[] edges;

    KruskalDirigido(int v, int e) {
        V = v;
        E = e;
        edges = new Edge[E];
        for (int i = 0; i < e; ++i) {
    ...
    void kruskalMST() {
        ...
        guardarResultadoEnArchivo(result, e, "ResultadosKruskalDirigido.txt");
    }
    ...
    public static void main(String[] args) {
        KruskalDirigido grafo = new KruskalDirigido(0, 0);
