...
class Graph {
    ...
    public void addEdge(int src, int dest, int weight) {
        adjList[src].add(new Edge(src, dest, weight)); // Añadir la arista solo en una dirección
    }
    ...
    public void guardarResultadosEnArchivo(int[] distancias) {
        String nombreArchivo = "ResultadosDijkstraDirigido.txt";
...
public class DijkstraDirigido {
    public static void main(String[] args) {
        ...
        String nombreArchivo = "Grafo30.txt";
